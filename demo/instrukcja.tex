...
\begin{table}[h!]
    \centering\caption{Co kto ma\nolink{harel_rzecz_2008} (patrz też dodatek~\ref{app:dod1}) \label{tabela:coktoma}}
...
\begin{minipage}{\textwidth}
    \begin{table}[H]
        \centering\caption{Rozwiązania konkurencyjne~- cechy funkcjonalne\label{tabela:rozwiazania-konkurencyjne-funkcjonalne}}
...
\begin{minipage}{\textwidth}
    \begin{table}[H]
        \centering\caption{Sformułowanie problemu\label{tabela:sformulowanie-problemu}}
