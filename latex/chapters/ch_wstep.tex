...
\imagewidest[\cite{daxx-nordic-2020}]{img/talent-shortage}{Niedobór wykwalifikowanych pracowników IT na świecie}{talent-shortage}
...
%         \item sprawdzenie czy wytypowane cechy będą miały odzwierciedlenie w~cechach opisywanych w~literaturze;
    \end{itemize}
%    \pagebreak %todo check if this should be here
    \item Utylitarne:
    \begin{itemize}
